...
void Process::showInputWin(bool flag)
{
	...
	{
		LCDControl->CutPicAndShow(3,66,141,188,55,66,141);    //显示背景色
	}
...
void Process::showControlStatus()
{
	if(2==controlStatusFlag)     //正在电击
	{
		...
		//显示电击
		LCDControl->CutPicAndShow(2,137,203,40,30,198,203);    //显示 电击
	...
	else if(1==controlStatusFlag) //正在警报
	{
		 ...
		 //显示警报
		LCDControl->CutPicAndShow(2,209,203,40,30,198,203);    //显示 警报

	}
	else
	{
		//没有动作，显示空白
		LCDControl->CutPicAndShow(2,250,203,40,30,198,203);    //显示 空白
	}
