...
{
	STM32_GpioOneInit(GPIO_Pin_4,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置AD_Pow通道
	STM32_GpioOneInit(GPIO_Pin_3,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置Ad_decCut通道
}
