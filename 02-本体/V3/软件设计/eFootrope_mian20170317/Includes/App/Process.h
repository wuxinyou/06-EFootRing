...
/*--宏定义:AD-----------------------------------------------------------------*/
//	电压采集
#define	AD_NUM_DECCUT 			1
#define AD_NUM_POWER		   	0

//	房间号，从001开始；每个房间内的设备ID，从01开始
#define	ID_ROOM				102		//	实际房间号
#define	ID_TERMINAL			10		//	实际本体号
...
class Process
{
	...
	private:
		...
		void    readySleep();     //准备休眠
		
		void    detectDecCut();   //检测表带断线
