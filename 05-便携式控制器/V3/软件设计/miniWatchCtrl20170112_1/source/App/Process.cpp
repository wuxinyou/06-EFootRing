  ...
  Process::Process()
{
	...
	initAllData();														//	初始化所有数据
//	testLed->setOn();													//	
	//SysTick_DelayMs(10);												//	按下电源开关1500ms后，再进行对液晶屏的操作
...
// 	dealKeyValue();														  //	处理按键
// #endif
	SysTick_DelayMs(160);												//	YL_EN使能后50ms 才能发送数据
	updataToZigbee();
// 	SysTick_DelayMs(5);												
// 	updataToZigbee();
// 	SysTick_DelayMs(5);												
...
//  	}
	...
	//喂狗
	static bool keyActionFlag=true;
