...
//	STM32_GpioOneInit(GPIO_Pin_1,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOB);	//	
	//STM32_GpioOneInit(GPIO_Pin_0,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOB);	//	
	//STM32_GpioOneInit(GPIO_Pin_5,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	
