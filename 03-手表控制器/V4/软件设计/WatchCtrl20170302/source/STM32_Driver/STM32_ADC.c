...
static	void	ADC1_GPIO_Config(void)
{
	...
	STM32_GpioOneInit(GPIO_Pin_3,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置AD_Key1通道
	
	STM32_GpioOneInit(GPIO_Pin_4,GPIO_Speed_50MHz,GPIO_Mode_AIN,GPIOA);	//	配置AD_KEY2
