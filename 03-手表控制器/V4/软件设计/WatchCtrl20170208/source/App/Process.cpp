...
{	
	...
	ledPow1        = new IoOut(LED_POW1_PORT,LED_POW1_PIN,true);//低电平有效
	ledPow2        = new IoOut(LED_POW2_PORT,LED_POW2_PIN,true);
...
void Process::getPowerValue(void)
{
	...
	tempValue  = AD_Filter[AD_NUM_KEY1]*33*3>>12;
...
{	
	...
	ADKey2Value  = AD_Filter[AD_NUM_KEY2]*33*3>>12;
