...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1|GPIO_Pin_11|GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_3|GPIO_Pin_8;	 //PD3,PD6ÍÆÍìÊä³ö  
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //ÍÆÍìÊä³ö
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//ËÙ¶È50MHz
 	GPIO_Init(GPIOB, &GPIO_InitStructure);	  //³õÊ¼»¯GPIOD3,6
 	GPIO_SetBits(GPIOB,GPIO_Pin_1|GPIO_Pin_11|GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_3|GPIO_Pin_8);	//PD3,PD6 Êä³ö¸ß
 ...
 #endif
//delay_ms(200);
Delay_1ms(1000);   //ÕâÀïµÄÑÓÊ±ºÜ½²¾¿£¬ÓÉÓÚÒº¾§ÆÁµçÂ·ÓÐµçÈÝÆ÷¼þ£¬ÐèÒªÒ»Ð©Ê±¼äÏÈ¸øÓ²¼þÉÏµç£¬È»ºó²ÅÄÜ·¢ËÍÖ¸Áî
